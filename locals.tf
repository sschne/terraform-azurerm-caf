...
locals {
  ...
  azuread = {
    ...
    azuread_access_packages                    = try(var.azuread.azuread_access_packages, {})
    azuread_access_package_catalogs            = try(var.azuread.azuread_access_package_catalogs, {})
    azuread_access_package_assignment_policies = try(var.azuread.azuread_access_package_assignment_policies, {})
  }
  ...
  messaging = {
    ...
    notification_hub_auth_rules  = try(var.messaging.notification_hub_auth_rules, {})
  ...
  security = {
    ...
    federated_identity_credentials      = try(var.security.federated_identity_credentials, {})
  }
