locals {
  remote_objects = {
    ...
    diagnostics                                    = try(local.combined_diagnostics, null)
    ...
    kusto_clusters                                 = try(local.combined_objects_kusto_clusters, null)
    ...
    notification_hub_namespaces                    = try(local.combined_objects_notification_hub_namespaces, {})
    notification_hubs                              = try(local.combined_objects_notification_hubs, {})
    notification_hub_auth_rules                    = try(local.combined_objects_notification_hub_auth_rules, {})
