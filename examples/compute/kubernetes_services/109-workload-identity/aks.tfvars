...
aks_clusters = {
  cluster_re1 = {
    ...
    # OIDC issuer and Workload Identity must be enabled in order for federated identity credentials to work
...
federated_identity_credentials = {
  example_fic = {
    ...
    subject              = "system:serviceaccount:example-namespace:example-serviceaccount"
  }
}
