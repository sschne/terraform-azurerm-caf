module "example" {
  ...
  azuread = {
    ...
    azuread_access_package_catalogs            = var.azuread_access_package_catalogs
    azuread_access_packages                    = var.azuread_access_packages
    azuread_access_package_assignment_policies = var.azuread_access_package_assignment_policies
  }
